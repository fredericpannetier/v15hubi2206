...
class ProductTemplate(models.Model):
    ...
    def action_used_in_bom(self):
        self.ensure_one()
        action = self.env["ir.actions.actions"]._for_xml_id("hubi_bom.hubi_bom_form_action")
    ...
    def action_view_mos(self):
        action = self.env["ir.actions.actions"]._for_xml_id("hubi_bom.mrp_production_report")
...
class ProductProduct(models.Model):
    ...
    used_in_bom_count = fields.Integer('# BoM Where Used', compute='_compute_used_in_bom_count', compute_sudo=False)
    #mrp_product_qty = fields.Float('Manufactured', compute='_compute_mrp_product_qty', compute_sudo=False)
    ...
    def action_view_bom(self):
        action = self.env["ir.actions.actions"]._for_xml_id("hubi_bom.product_open_bom")
